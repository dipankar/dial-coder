...
```bash
git clone https://github.com/dipankar/dial-coder.git # Or your fork's URL
cd dial-coder
```
...
- Consult [QWEN.md](https://github.com/dipankar/dial-coder/blob/main/QWEN.md) (typically found in the project root) for specific instructions related to AI-assisted development, including conventions for React, comments, and Git usage.
