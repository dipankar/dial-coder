...
import { useDialStream } from './useDialStream.js';
...
// --- Tests for useDialStream Hook ---
describe('useDialStream', () => {
  ...
  beforeEach(() => {
    ...
    } as unknown as any); // DialChat -> any
  ...
  const mockLoadedSettings: LoadedSettings = {
    ...
    workspace: { path: '/workspace/.dial/settings.json', settings: {} },
    errors: [],
    forScope: vi.fn(),
    setValue: vi.fn(),
