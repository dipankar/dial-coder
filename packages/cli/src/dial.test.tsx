...
describe('dial.tsx main function', () => {
  let originalEnvDialSandbox: string | undefined;
  ...
  beforeEach(() => {
    ...
    originalEnvDialSandbox = process.env['DIAL_SANDBOX'];
  ...
  afterEach(() => {
    ...
    if (originalEnvDialSandbox !== undefined) {
      process.env['DIAL_SANDBOX'] = originalEnvDialSandbox;
    } else {
      delete process.env['DIAL_SANDBOX'];
    }
...
describe('dial.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['DIAL_CLI_NO_RELAUNCH'];
    process.env['DIAL_CLI_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['DIAL_CLI_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['DIAL_CLI_NO_RELAUNCH'];
    }
  });
