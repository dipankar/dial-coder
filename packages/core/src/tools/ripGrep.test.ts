...
describe('RipGrepTool', () => {
  ...
  describe('execute', () => {
    ...
    it('should pass .dialignore to ripgrep when respected', async () => {
      await fs.writeFile(
    ...
    it('should include .dialignore matches when disabled in config', async () => {
      await fs.writeFile(path.join(tempRootDir, '.dialignore'), 'kept.txt\n');
