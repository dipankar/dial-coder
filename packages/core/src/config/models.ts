...
export const DEFAULT_DIAL_MODEL = 'coder-model';
export const DEFAULT_DIAL_FLASH_MODEL = 'coder-model';
export const DEFAULT_DIAL_EMBEDDING_MODEL = 'text-embedding-v4';
