...
import { DIAL_CODE_COMPANION_EXTENSION_NAME } from './constants.js';
  ...
  async install(): Promise<InstallResult> {
    ...
    try {
      const result = child_process.spawnSync(
        ...
        [
          '--install-extension',
          'dialcode.dial-code-vscode-ide-companion',
          '--force',
        ],
      ...
      return {
        success: false,
        message: `Failed to install ${this.ideInfo.displayName} companion extension. Please try installing '${DIAL_CODE_COMPANION_EXTENSION_NAME}' manually from the ${this.ideInfo.displayName} extension marketplace.`,
      };
    }
  }
}
