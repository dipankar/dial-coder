  ...
  describe('buildHeaders', () => {
    ...
    it('should add OpenRouter-specific headers', () => {
      ...
      expect(headers).toEqual({
        ...
        'HTTP-Referer': 'https://github.com/neul-labs/dial-coder.git',
        'X-Title': 'Qwen Code',
      });
    });
    ...
    it('should override parent headers if there are conflicts', () => {
      ...
      expect(headers).toEqual({
        'User-Agent': 'ParentAgent/1.0.0',
        'HTTP-Referer': 'https://github.com/neul-labs/dial-coder.git', // OpenRouter-specific value should override
        'X-Title': 'Qwen Code',
      });
    ...
    it('should handle unknown CLI version from parent', () => {
      ...
      expect(headers['HTTP-Referer']).toBe(
        'https://github.com/neul-labs/dial-coder.git',
      );
