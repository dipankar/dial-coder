...
You can provide persistent context to the model by adding a `DIAL.md` file to your extension. This is useful for giving the model instructions on how to behave or information about your extension's tools. Note that you may not always need this for extensions built to expose commands and prompts.

1.  Create a file named `DIAL.md` in the root of your extension directory:
...
Restart the CLI again. The model will now have the context from your `DIAL.md` file in every session where the extension is active.
