...
When you start Dial Coder in a project directory that contains a previously generated project summary (`.dial/PROJECT_SUMMARY.md`), the Welcome Back dialog will automatically appear, giving you the option to either start fresh or continue your previous conversation.
...
2. **Automatic Detection:** Next time you start Dial Coder in this project, Welcome Back will detect the summary
