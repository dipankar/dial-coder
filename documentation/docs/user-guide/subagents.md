...
Subagents are specialized AI assistants that handle specific types of tasks within Dial Coder. They allow you to delegate focused work to AI agents that are configured with task-specific prompts, tools, and behaviors.
...
Dial Coder proactively delegates tasks based on:
