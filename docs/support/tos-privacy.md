# Dial Coder: Terms of Service and Privacy Notice

Dial Coder is an open-source AI coding assistant tool maintained by the Dial Coder team. This document outlines the terms of service and privacy policies that apply when using Dial Coder's authentication methods and AI model services.

## How to determine your authentication method

Dial Coder supports two main authentication methods to access AI models. Your authentication method determines which terms of service and privacy policies apply to your usage:
...
**Important:** When using OpenAI-compatible API authentication, you are subject to the terms and privacy policies of your chosen API provider, not Dial Coder's terms. Please review your provider's documentation for specific details about data usage, retention, and privacy practices.

Dial Coder supports various OpenAI-compatible providers. Please refer to your specific provider's terms of service and privacy policy for detailed information.

## Usage Statistics and Telemetry

Dial Coder may collect anonymous usage statistics and telemetry data to improve the user experience and product quality. This data collection is optional and can be controlled through configuration settings.

### What Data is Collected

When enabled, Dial Coder may collect:
...
- **Qwen OAuth:** Usage statistics are governed by Qwen's privacy policy. You can opt-out through Dial Coder's configuration settings.
- **OpenAI-Compatible API:** No additional data is collected by Dial Coder beyond what your chosen API provider collects.
...
**Important**: Dial Coder itself does not use your prompts, code, or responses for model training. Any data usage for training purposes would be governed by the policies of the AI service provider you authenticate with.

### 2. What are Usage Statistics and what does the opt-out control?

The **Usage Statistics** setting controls optional data collection by Dial Coder for improving the user experience and product quality.
...
**What is NOT collected by Dial Coder:**
...
The Usage Statistics setting only controls data collection by Dial Coder itself. It does not affect what data your chosen AI service provider (Qwen, OpenAI, etc.) may collect according to their own privacy policies.
